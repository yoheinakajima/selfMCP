...
def build_server() -> FastMCP:
    mcp = FastMCP(
        ...
        instructions=(
            ...
            "Composition: a skill body can call other skills via "
            "`from selfmcp_sdk import run_skill, search_skills, get_skill, list_skills` — "
            "the executor injects the SDK on PYTHONPATH automatically, so a skill can "
            "discover and invoke other registered skills without going back through MCP. "
            ...
            "versioning, execution, composition, auth, all 8 tools, and setup. "
